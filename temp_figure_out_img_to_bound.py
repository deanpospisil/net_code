...
def arc_neigbor_max_2d(im, cur_ind, around):
    ...
    max_ind = aind[np.argmax([im[i[0], i[1]] for i in aind])]
    return max_ind
...
#im = stack[0,:,:]
for i in range(100):
    im = np.load('/Users/dean/Desktop/Modules/net_code/images/baseimgs/formlet/' + str(i) + '.npy')
    scale = 10.
    radius = 5.
